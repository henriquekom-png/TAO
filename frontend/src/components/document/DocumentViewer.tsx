...
const BlocoItem: React.FC<BlocoItemProps> = ({
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class:
          'w-full min-h-[120px] text-[15px] p-3 outline-none bg-transparent text-zinc-900 dark:text-zinc-100 prose dark:prose-invert prose-sm max-w-none focus:outline-none',
      },
    },
  });
            ...
            {isEditing ? (
              <div className="mt-1" onClick={(e) => e.stopPropagation()}>
                ...
                <div className={cn(
                  ...
                  localImportancia === 'vital' ? "border-red-300 dark:border-red-800 focus-within:ring-red-100 dark:focus-within:ring-red-900 shadow-sm bg-red-50/10 dark:bg-zinc-900" : 
                  localImportancia === 'importante' ? "border-amber-300 dark:border-amber-700 focus-within:ring-amber-100 dark:focus-within:ring-amber-900 shadow-sm bg-amber-50/10 dark:bg-zinc-900" :
                  "border-blue-400 dark:border-zinc-700 focus-within:ring-blue-100 dark:focus-within:ring-zinc-800"
                )}>
              ...
              <div className={cn('text-slate-800 dark:text-slate-300 text-[15px] leading-relaxed font-sans transition-colors',
                ...
                bloco.cor_fonte === 'destaque' && 'bg-yellow-100 dark:bg-yellow-900/30 px-1 rounded-sm text-yellow-900 dark:text-yellow-200',
